...
const SparklesIcon: React.FC<React.SVGProps<SVGSVGElement>> = props => (
  ...
  >
    <path
      ...
      d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L1.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.25 12L17 14.188V12.001L18.25 12z"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M15.75 12a3.75 3.75 0 00-7.5 0M12.75 19.5a3.75 3.75 0 007.5 0M12.75 4.5a3.75 3.75 0 007.5 0M17.25 12a.75.75 0 010 1.5h-.008a.75.75 0 010-1.5H17.25z"
    />
  </svg>
);
...
export const PromptEnhancementForm: React.FC<PromptEnhancementFormProps> = ({
  ...
  return (
    ...
    >
      ...
      <div>
        <h2 className="text-2xl font-semibold text-indigo-400 mt-8 mb-1">
      ...
      {isImageModel && (
        <div>
          <h2 className="text-2xl font-semibold text-indigo-400 mt-8 mb-1">
            {t('form.section3.title', { modelName: selectedAiModel?.label || 'Image AI' })}
          </h2>
      ...
      <div className="pt-5">
        <Button
          ...
          variant="primary"
          isLoading={isLoading}
          disabled={isLoading || !params.initialPrompt}
